class RecipeFoodController < ApplicationController
  ...
  def create
    ...
    if @recipe_food.save
      flash[:success] = 'New Recipe food was successfully created.'
  ...
  def update
    if @recipe_food.update(food: @food, quantity: recipe_food_params[:quantity])
      flash[:success] = 'The Recipe food has been successfully updated.'
  ...
  def destroy
    if @recipe_food.destroy
      flash[:success] = 'The Recipe food was successfully removed.'
    else
      flash.now[:error] = 'Sorry, Recipe food could not be removed'
    end
    redirect_to recipe_url(@recipe)
  end
